// src/lib.rs
/*
 * Core library for WeaviateStore
 */
...
#[derive(Debug)]
pub struct WeaviateStoreProcessor {
    verbose: bool,
    processed_count: usize,
}

impl WeaviateStoreProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting WeaviateStore processing");
    
    let mut processor = WeaviateStoreProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = WeaviateStoreProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = WeaviateStoreProcessor::new(false);
